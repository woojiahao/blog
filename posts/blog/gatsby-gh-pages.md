...
![GitHub remote branches](/gatsby-deployment-tutorial/remote-branches.png)
...
![GitHub changing default branches](/gatsby-deployment-tutorial/default-branch.png)
...
![GitHub access token settings location](//gatsby-deployment-tutorial/access-token-location.png)

When generating the token, restrict the token's scope to `repo` only.

![GitHub create token](/gatsby-deployment-tutorial/create-token.png)
...
![GitHub add secret](/gatsby-deployment-tutorial/add-secret.png)
